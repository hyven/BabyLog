...
//  BabyLog
//
//  Created by jiangbin on 15/6/17.
...
- (void)viewDidLoad {
    ...
    itemsArray = [NSMutableArray arrayWithObjects:@"女",@"男", nil];
    ...
    [okBtn addTarget:self action:@selector(selectSex) forControlEvents:UIControlEventTouchUpInside];
...
- (void)selectSex
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SelectSex" object: bt];
