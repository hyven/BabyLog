...
-(void)defaultSettings
{
    ...
    _listTable.layer.borderColor = kTableBorderColor.CGColor;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell==nil)
    {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(2, 0, self.frame.size.width-4, tableLineH)];
        ...
        UIImageView *line = [[UIImageView alloc]initWithFrame:CGRectMake(0, tableLineH-0.5, self.frame.size.width, 0.5)];
        line.backgroundColor = kTableBorderColor;
